...
class TestImpl implements Test {
  ...
  factory TestImpl(ExternalLibrary dylib) => TestImpl.raw(TestPlatform(dylib));

  /// Only valid on web/WASM platforms.
  factory TestImpl.wasm(FutureOr<WasmModule> module) =>
      TestImpl(module as ExternalLibrary);
  TestImpl.raw(this._platform);
  Future<int> multiply({required int a, required int b, dynamic hint}) {
...
class TestPlatform extends FlutterRustBridgeBase<TestWire> {
  TestPlatform(ffi.DynamicLibrary dylib) : super(TestWire(dylib));
...
class TestWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  TestWire(ffi.DynamicLibrary dynamicLibrary) : _lookup = dynamicLibrary.lookup;
